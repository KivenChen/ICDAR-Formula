...
from ..board_ops import runops, tfbwriter, runmeta
...
class BaseModel(object):
    ...
    def init_session(self):
        ...
        confy = tf.ConfigProto()
        confy.gpu_options.allocator_type = 'BFC'
        self.sess = tf.Session()
        self.sess.run(tf.global_variables_initializer(), options=runops, run_metadata=runmeta)
        tfbwriter.add_run_metadata(runmeta, "initialization")
